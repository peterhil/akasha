...
class ExponentialTest(unittest.TestCase):
    ...
    def testExponentialDecay(self):
        e = Exponential(-1, 1.0)
        self.assertEqual(1.0/math.e, e.sample(1.0))
        f = Exponential(-2, 1.0)
        self.assertEqual(1.0/math.e**2, f.sample(1.0))

    def testExponentialGrowth(self):
        e = Exponential(1, 1.0)
        self.assertEqual(math.e, e.sample(1.0))
        f = Exponential(5, 1.0)
        self.assertAlmostEqual(math.e**5, f.sample(1.0))
